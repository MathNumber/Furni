...
<body>
			...
			<div class="row justify-content-between">
				<div class="col-lg-5">
					<div class="intro-excerpt">
						<h1>Contact</h1>
						<p class="mb-4">We are thrilled that you've taken the time to
							reach out to us and explore ways we can assist you further.</p>
						<p>
	...
	<!-- Start Contact Form -->
	<div class="untree_co-section" id="explore">
		<div class="container">
					...
					<div class="col-md-8 col-lg-8 pb-4">
							...
							<div class="col-lg-4">
								<div
									...
									<div class="service-contents">
										<p>Phú Dương, Phú Vang, Thừa Thiên Huế</p>
									</div>
									<!-- /.service-contents-->
								</div>
								<!-- /.service -->
						...
						<form method="post">
							<div class="row">
								...
								<div class="col-6">
									<div class="form-group">
										<label class="text-black" for="name">Name</label> <input
							...
							<button id="btn" class="btn btn-primary-hover-outline">Send
								Message</button>
						</form>
